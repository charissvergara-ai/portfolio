      ...
      <div className="w-full max-w-md px-4">
        <div className="rounded-2xl bg-white p-8 shadow-md">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-black text-text-dark">Welcome Back</h1>
            <p className="mt-1 text-sm text-gray-500">Sign in to your KaGuro Ph account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-full bg-primary py-3 font-bold text-white transition-colors hover:hover:bg-sky-500/100 disabled:opacity-50"
            >
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/sign-up" className="font-bold text-primary hover:underline">Sign Up</Link>
          </p>
        </div>
      </div>
    </section>
